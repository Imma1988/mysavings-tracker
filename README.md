...
Nos resgates, regista a data do pedido. E essa data que a app usa para calcular a valorizacao e o imposto.
...
2. Regista cada resgate com a data do pedido e o valor bruto do resgate.
